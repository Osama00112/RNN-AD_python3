...
python -m cbig.osama2024.baseline_constant --spreadsheet data/TADPOLE_D1_D2.csv --mask output/fold0_mask.csv --out output/constant_prediction.csv

python -m cbig.osama2024.evaluation --reference output/fold0_test.csv --prediction output/constant_prediction.csv
