...
data <- read_excel("12_22f.xlsx")

# Add columns for the color grouping for each condition
data$Color_CN <- c("purple", "purple", "purple", "red", "red", "purple", 
                   "green", "green", "purple", "purple", "green", "purple")
data$Color_MCI <- c("green", "green", "purple", "red", "red", "purple", 
                    "purple", "purple", "purple", "purple", "purple", "green")
data$Color_AD <- c("purple", "purple", "red", "purple", "red", "red", 
                   "green", "purple", "purple", "purple", "purple", "green")
